...
@Component({
  selector: 'app-flt-order-to-charity-created-at-tbl',
  imports: [
    ButtonModule, 
    PopoverModule, 
    CommonModule, 
  ...
  templateUrl: './flt-order-to-charity-created-at-tbl.component.html',
  styleUrl: './flt-order-to-charity-created-at-tbl.component.scss',
  providers: []
})
export class FltOrderToCharityCreatedAtTblComponent implements OnInit, AfterViewInit, OnDestroy {
