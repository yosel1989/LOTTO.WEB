...
import { Listbox, ListboxFilterOptions, ListboxModule } from 'primeng/listbox';

@Component({
  selector: 'app-flt-order-employees-created-tbl',
  imports: [
    MultiSelectModule,
    ButtonModule,
    MessageModule,
  ...
  templateUrl: './flt-order-employees-created-tbl.component.html',
  styleUrl: './flt-order-employees-created-tbl.component.scss',
  providers: []
})
export class FltOrderEmployeesCratedTblComponent implements OnInit, AfterViewInit, OnDestroy {
