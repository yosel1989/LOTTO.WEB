...
@Component({
  selector: 'app-flt-order-origin-tbl',
  imports: [
    MultiSelectModule,
    ButtonModule,
    MessageModule,
  ...
  templateUrl: './flt-order-origin-tbl.component.html',
  styleUrl: './flt-order-origin-tbl.component.scss',
  providers: []
})
export class FltOrderOriginTblComponent implements OnInit, AfterViewInit, OnDestroy {
