...
@Component({
  selector: 'app-flt-order-locales-created-tbl',
  imports: [
    MultiSelectModule,
    ButtonModule,
    MessageModule,
  ...
  templateUrl: './flt-order-locales-created-tbl.component.html',
  styleUrl: './flt-order-locales-created-tbl.component.scss',
  providers: []
})
export class FltOrderLocalesCratedTblComponent implements OnInit, AfterViewInit, OnDestroy {
