...
@Component({
  selector: 'app-flt-order-payment-type-tbl',
  imports: [
    MultiSelectModule,
    ButtonModule,
    MessageModule,
  ...
  templateUrl: './flt-order-payment-type-tbl.component.html',
  styleUrl: './flt-order-payment-type-tbl.component.scss',
  providers: []
})
export class FltOrderPaymentTypeTblComponent implements OnInit, AfterViewInit, OnDestroy {
